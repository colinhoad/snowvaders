  ...
  650 L%=0:M%=3:F%=-99:G%=-99:DIR%=1:SH%=4:WI%=14:DE%=10:DEP%=7:RX%=-1:RT%=0:RP%=LEVEL%*10+20+RND(20):IFDEAD%=0 OHIT%=OHIT%+(LEVEL%+1)MOD2:IFOHIT%>3 OHIT%=OHIT%-3
  ...
  710 R%=FNR:PROCmb:F%=L%:G%=M%:PROCb:PROCmb:PROCmoveman
  720 IFDOWN% DIR%=NDIR%:IFLEVEL%>5ORR%=-1 M%=M%+1:G%=M% ELSEL%=L%+DIR%
 ...
 1830 DEFPROCv
 1840 IFL%=-1 L%=L%+1:F%=1:FORLO%=0TO7:V$(LO%)=LEFT$(V$(LO%),2)+MID$(V$(LO%),4):S$(LO%)=MID$(S$(LO%),2):NEXT:WI%=WI%-1
 1850 FORLO%=0TO7
 ...
 1875 IF G%=M% PRINTTAB(F%,G%-1);SPC(20):PRINTTAB(F%,G%+2);SPC(20):PRINTTAB(F%,G%+5);SPC(20):PRINTTAB(F%,G%+8);SPC(20)
 1880 IF F%<>-99 PRINTTAB(F%,G%);S$(0):PRINTTAB(L%,M%);V$(0) ELSE PRINTTAB(L%,M%);V$(0)
 1890 IF F%<>-99 PRINTTAB(F%,G%+1);S$(1):PRINTTAB(L%,M%+1);V$(1) ELSE PRINTTAB(L%,M%+1);V$(1)
 1910 IF F%<>-99 PRINTTAB(F%,G%+3);S$(2):PRINTTAB(L%,M%+3);V$(2) ELSE PRINTTAB(L%,M%+3);V$(2)
 1920 IF F%<>-99 PRINTTAB(F%,G%+4);S$(3):PRINTTAB(L%,M%+4);V$(3) ELSE PRINTTAB(L%,M%+4);V$(3)
 1940 PROCmb
 1950 IF F%<>-99 PRINTTAB(F%,G%+6)S$(4):PRINTTAB(L%,M%+6);V$(4) ELSE PRINTTAB(L%,M%+6);V$(4)
 1960 IF F%<>-99 PRINTTAB(F%,G%+7);S$(5):PRINTTAB(L%,M%+7);V$(5) ELSE PRINTTAB(L%,M%+7);V$(5)
 1980 IF F%<>-99 PRINTTAB(F%,G%+9);S$(6):PRINTTAB(L%,M%+9);V$(6) ELSE PRINTTAB(L%,M%+9);V$(6)
 1990 IF F%<>-99 PRINTTAB(F%,G%+10);S$(7):PRINTTAB(L%,M%+10);V$(7); ELSE PRINTTAB(L%,M%+10);V$(7);
 2000 PROCmovebs
 2010 ENDPROC
 2020 DEFPROCb
 2070 PROCmb
